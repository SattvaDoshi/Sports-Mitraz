    ...
    <>
      ...
      <div className="pdp">
        <div className="pdp__wrap">
          ...
          <div className="pdp__gallery">
            ...
            {/* Gallery Thumbnails cleanly positioned under the main photo */}
            {gallery.length > 0 && (
              <div className="pdp__thumbs">
                {gallery.map((img, i) => (
                  ...
                  >
                    <Image src={img} alt="" fill sizes="64px" className="pdp__thumb-img" />
                  </button>
                ))}
              </div>
            )}
          ...
          <div className="pdp__info">
            ...
            {product.description && (
              <div className="pdp__description-box">
                <p className="pdp__description-title">Product Description</p>
            ...
            {product.colors?.length ? (
              <div className="pdp__section">
                <p className="pdp__section-label">
                  Colour
                  {selectedColor ? <span className="pdp__selected-value">{selectedColor}</span> : null}
                </p>
      ...
      <style jsx>{`
        ...
        .pdp__main-media {
          ...
          overflow: hidden;
          background: #ffffff;
          box-shadow: 0 12px 32px -16px rgba(22, 53, 41, 0.25);
